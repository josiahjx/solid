    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-blocks-icon lucide-blocks"><path d="M10 22V7a1 1 0 0 0-1-1H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5a1 1 0 0 0-1-1H2"/><rect x="14" y="2" width="8" height="8" rx="1"/></svg>
              <span className="font-bold text-xl">CapitalNodeAnalytics</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">support@CapitalNodeAnalytics.com</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2023 CapitalNodeAnalytics. All rights reserved. | <Link href="/privacy" className="hover:text-white transition">Privacy Policy</Link> | <Link href="/privacy" className="hover:text-white transition">Terms of Service</Link></p>
        </div>
      </div>
    </footer>
  );
